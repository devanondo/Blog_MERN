  ...
  return (
    <>
      <button
        ...
        className="mx-auto  focus:outline-none md:ml-5 bg-indigo-700 dark:bg-indigo-600 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-6 py-2 text-sm"
      >
        Create Blog
      </button>
