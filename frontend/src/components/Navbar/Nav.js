            ...
            <div className="h-full flex">
              ...
              >
                {isAuthenticated ? (
                  <>
                    {profile && (
                      <ul className="p-2 z-50 w-40 border-r bg-white absolute rounded left-0 shadow mt-16 top-0 ">
                  ...
                  <ul className="flex gap-3 items-center">
                    <Link to="/login" className="px-2 py-1 pointer text-xs  ">
                      Sign In
                    </Link>
                    <Link
                      to="/register"
                      className="px-3 py-2 pointer text-xs bg-indigo-700 text-white rounded"
                    >
                      Sign Up
                    </Link>
                  </ul>
